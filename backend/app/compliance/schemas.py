...
class ProjectComplianceInput(BaseModel):
    ...
    expected_impact: Optional[float] = Field(default=None, ge=0)
    csr_alignment: Optional[float] = Field(default=None, ge=0)
    feasibility: Optional[float] = Field(default=None, ge=0)
    sustainability: Optional[float] = Field(default=None, ge=0)
